...
export const applySoulSerum = (maskCanvas, width, height) => {
    ...
    const radialGradient = serumCtx.createRadialGradient(centerX, centerY, width * 0.1, centerX, centerY, Math.max(width, height) / 1.2);
